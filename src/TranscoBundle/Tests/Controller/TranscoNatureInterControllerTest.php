...
class TranscoNatureInterControllerTest extends BaseWebTestCase
{
    ...
    public function testGetAllAction()
    {
        ...
        $transcoNatureInters = $this->em->getRepository('TranscoBundle:TranscoNatureInter')->findAll();
    ...
    public function testGetAction()
    {
        ...
        $transcoNatureInter = $this->em->getRepository('TranscoBundle:TranscoNatureInter')->findAll()[0];
        $this->client->request(
            'GET',
    ...
    public function testDeleteAction()
    {
        ...
        $transcoNatureInter = $this->em->getRepository('TranscoBundle:TranscoNatureInter')->find($id);
