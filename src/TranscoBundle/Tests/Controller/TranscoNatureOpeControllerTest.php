...
class TranscoNatureOpeControllerTest extends BaseWebTestCase
{
    ...
    public function testGetAllAction()
    {
        ...
        $transcoNatureOpes = $this->em->getRepository('TranscoBundle:TranscoNatureOpe')->findAll();
    ...
    public function testGetAction()
    {
        ...
        $transcoNatureOpe = $this->em->getRepository('TranscoBundle:TranscoNatureOpe')->findAll()[0];
    ...
    public function testDeleteAction()
    {
        ...
        $transcoNatureOpe = $this->em->getRepository('TranscoBundle:TranscoNatureOpe')->find($id);
