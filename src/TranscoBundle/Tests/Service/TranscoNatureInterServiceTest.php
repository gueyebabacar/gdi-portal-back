...
use TranscoBundle\Service\TranscoNatureInterService;
...
class TranscoNatureInterServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testGetAll()
    {
        ...
        $this->emProphecy
            ->getRepository("TranscoBundle:TranscoNatureInter")
    ...
    public function testGet()
    {
        ...
        $this->emProphecy
            ->getRepository(Argument::exact('TranscoBundle:TranscoNatureInter'))
            ->willReturn($this->repositoryProphecy)
            ->shouldBeCalled();
